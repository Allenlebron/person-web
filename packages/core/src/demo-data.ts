...
export const siteSettings: SiteSettings = {
  name: "Panzhiwei's Blog",
  description:
    "Panzhiwei's personal blog for technical practice, product thinking, and durable notes.",
  url: "https://person-web.myzwilpan.workers.dev",
  authorName: "panzhiwei",
  authorBio: "Writing about technical practice, product thinking, and reusable knowledge.",
  avatarUrl: "/og-default.svg",
  defaultOgImage: "/og-default.svg",
  socialLinks: [
    { label: "GitHub", href: "https://github.com/Allenlebron/person-web" },
  ...
  i18n: {
    ...
    description: {
      zh: "Panzhiwei 的个人博客，用于沉淀技术实践、产品思考和长期笔记。",
    },
    authorBio: {
      zh: "记录技术实践、产品思考和长期可复用的知识。",
    },
  },
};
